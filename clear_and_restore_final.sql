...
-- Insert data with correct project URLs
...
-- Note: You'll need to upload the actual images to your new Supabase storage
-- and update these URLs with the correct paths
